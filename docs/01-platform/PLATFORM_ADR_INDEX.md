...
| [ADR-0016: Template Versioning and PDF Rendering](../05-decisions/ADR-0016-template-versioning-and-pdf-rendering.md) | Proposed | Defines template ownership, immutable version snapshots, merge contracts, PDF renderer selection, and renderer independence for Platform Release 1.4. |
