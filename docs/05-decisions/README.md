...
- [ADR-0023-self-service-password-reset-security-boundary.md](ADR-0023-self-service-password-reset-security-boundary.md): propose the dedicated reset-token lifecycle, canonical link origin, enumeration resistance, shared rate limiting, atomic all-session revocation, and relationship to ADR-0022.
