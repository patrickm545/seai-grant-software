import { solarGrantCounties, type SolarGrantCounty } from './solargrant-jurisdiction';
...
export const counties = solarGrantCounties;
...
export type County = SolarGrantCounty;
